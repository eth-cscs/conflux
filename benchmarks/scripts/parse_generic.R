...
#-------------------------SETUP----------------------#
path = "C:/gk_pliki/uczelnia/doktorat/performance_modelling/repo/papers/MMM-paper/results/generic" #getwd()
...
violinData = rawData[rawData$mShape == 'flat' | rawData$mShape == 'square',]
...
violinData[violinData$case == "square_memory_p0",]$case = "square, limited memory"
violinData[violinData$case == "square_memory_p1",]$case = "square extra memory"
violinData[violinData$case == "square_strong",]$case = "square, strong scaling"
violinData[violinData$case == "flat_memory_p0",]$case = "'flat', limited memory"
violinData[violinData$case == "flat_memory_p1",]$case = "'flat' extra memory"
violinData[violinData$case == "flat_strong",]$case = "'flat', strong scaling"
