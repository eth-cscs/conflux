  ...
  for (alg in algorithms){
    ...
    for (scaling in scalings){
      ...
      for (size in sizes[[scaling]]){
        ...
        else if (alg == 'LU' && scaling == 'fixed_P')  {
          annotPointX1 = c(100000,100000,100000,100000)
          
          annotx = c(100000,100000,100000,100000)
          annoty = c(18,7,30,40)
          
          annotPointX2 = c(100000,100000,100000,100000)
          annotPointY2 = c(21,10,28,40)
        }
        else if (alg == 'Cholesky' && scaling == 'fixed_P')  {
          annotPointX1 = c(100000,100000,100000,100000)
        ...
        if (variant == "bytes") {
          p <- ggplot(mapping=aes(x=N, y=min, fill=library, color=library, shape=library)) +
          ...
          p <- ggplot(mapping=aes(x=N, y=mean, ymin=min, ymax=max, fill=library, color=library, shape=library)) +
